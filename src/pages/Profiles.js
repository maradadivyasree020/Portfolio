      ...
      <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {
          list.map((li)=>(
            <CardContainer className="inter-var">
              <CardBody className="bg-white/20 backdrop-blur-md text-white relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-white/10 dark:border-white/[0.2] border-white/30 w-auto sm:w-[15rem] h-auto rounded-xl p-6 border">
                {/* Heading */}
                ...
                <div className="flex justify-between items-center mt-[10px]">
                  {/* Hosted Link */}
                  <CardItem className="text-xs font-normal text-white ">Highest Rating:</CardItem>
                  <CardItem translateZ={20} as={Link} href="https://twitter.com/mannupaaji" target="__blank" className="px-4 py-2 rounded-xl text-xs font-normal text-white dark:text-white">View</CardItem>
                  </div>
              </CardBody>
            </CardContainer>
          ))
