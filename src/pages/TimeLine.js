      ...
      <div className="relative w-full max-w-5xl">
        ...
        >
          <div className="relative w-full">
            ...
            <div className="absolute -right-4 top-6 w-4 h-4 bg-pink-500 rounded-full border-4 border-black"></div>
        ...
        >
          <div className="relative w-full">
            ...
            <div className="absolute -left-4 top-6 w-4 h-4 bg-purple-500 rounded-full border-4 border-black"></div>
